...
const sparkUv = document.getElementById("sparkUv");
...
function renderSensorData() {
  ...
  applyMetricValue(metricUv, fmtNumber(readings.uv_index, 1));
  ...
  applyMetricValue(labelUv, labels.uv || "--");
  ...
  renderSparkline(sparkUv, series.uv_index || [], "#bf5e57");
